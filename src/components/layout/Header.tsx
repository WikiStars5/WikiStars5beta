...
export function Header({ theme, toggleTheme }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-card text-card-foreground">
      <div className="container flex h-18 max-w-screen-2xl items-start justify-between py-3"> {/* Header height h-18 (72px), items-start for top alignment, py-3 for some padding */}

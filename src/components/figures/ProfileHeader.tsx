...
export function ProfileHeader({ 
  ...
  return (
    <div className="w-full bg-card p-4 sm:p-6 rounded-lg shadow-md">
        <div className="flex flex-col items-center md:flex-row md:items-center md:space-x-5">
          ...
          <div className="flex-grow flex flex-col md:flex-row justify-between items-center w-full mt-4 md:mt-0">

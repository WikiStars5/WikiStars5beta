...
export const updateCharacterRatings = onDocumentWritten("reviews/{reviewId}", (event: FirestoreEvent<admin.firestore.Change<DocumentSnapshot> | undefined, { reviewId: string; }>) => {
